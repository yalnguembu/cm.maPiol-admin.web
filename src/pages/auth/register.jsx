            ...
            <div className="auth-box h-full flex flex-col justify-center">
              ...
              <div className="text-center 2xl:mb-10 mb-5">
                ...
                <div className="text-slate-500 dark:text-slate-400 text-base">
                  Create an account to start using Ma Piol
                </div>
              </div>
              <RegForm />
              ...
              <div className="max-w-[215px] mx-auto font-normal text-slate-500 dark:text-slate-400 2xl:mt-12 mt-6 Capitalise text-sm">
                Already registered?
                <Link
                  to="/auth/login"
