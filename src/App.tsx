...
const ChatPage = lazy(() => import("./ui/pages/app/chat/ConversationList"));
          ...
          <Route path="owner" element={<OwnerMiddleWare />}>
            ...
            <Route path="contracts">
              <Route
                path="pending"
                element={
                  <ContractListPage status={ContractStatusFilter.PENDING} />
                }
              />
          ...
          <Route path="admin" element={<AdminMiddleWare />}>
            ...
            <Route path="contracts">
              ...
              <Route
                path="in-progress"
                element={
                  <ContractListPage status={ContractStatusFilter.IN_PROGRESS} />
                }
              />
              <Route
                path="done"
                element={
                  <ContractListPage status={ContractStatusFilter.DONE} />
                }
              />
              <Route
                path="cancelled"
                element={
                  <ContractListPage status={ContractStatusFilter.CANCELLED} />
                }
              />
            </Route>
          </Route>
